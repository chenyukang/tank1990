...
- Base and standalone UI icon manifest entries include generated sprite dimensions; the generated fallback distinguishes an intact emblem, destroyed rubble, a score badge, a stage flag, and a shield overlay.
